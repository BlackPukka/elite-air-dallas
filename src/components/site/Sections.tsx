...
const WHATSAPP = "https://wa.me/12145550142";
const WHATSAPP_TEXT = "Hi Elite Air Dallas";
...
export function Nav() {
  ...
  return (
    <header
      className={`fixed top-0 inset-x-0 z-40 transition-all ${scrolled ? "glass border-b border-border py-2" : "py-4"}`}
    >
      <div className="container mx-auto px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <a href="#booking" className="btn-elite is-primary h-10 px-4 sm:px-5 text-sm">
            Book
          </a>
          <button
            type="button"
            className="btn-elite is-ghost is-icon lg:hidden"
        ...
        <div className="lg:hidden border-t border-border bg-background/95 backdrop-blur-xl">
          <nav className="container mx-auto px-6 py-4 flex flex-col gap-1">
            ...
            <a
              href={`tel:${PHONE}`}
              onClick={closeMenu}
              className="mt-2 rounded-xl px-4 py-3 text-base font-medium flex items-center gap-2 text-gold"
            >
  ...
  return (
    ...
    >
      <div className="absolute inset-0 -z-10">
        <img
          src={heroImg}
          alt="Luxury HVAC technician installing premium air conditioning system in a Dallas home"
          width={1920}
          height={1080}
      ...
      <div className="container mx-auto px-6 grid lg:grid-cols-12 gap-10 items-center">
        <div className="lg:col-span-7 text-white animate-fade-up">
          ...
          <p className="mt-7 max-w-xl text-lg text-white/75 leading-relaxed">
            White-glove HVAC, AC repair & furnace service for Dallas' finest homes. Same-day
            response. 10-year warranties. Zero surprises — guaranteed.
          </p>
          <div className="mt-9 flex flex-wrap gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener"
              className="btn-elite is-ghost h-14 px-7 text-white text-base"
            >
          ...
          <div className="mt-10 flex flex-wrap items-center gap-6 text-sm text-white/70">
            <div className="flex items-center gap-2">
              <Clock className="size-4 text-gold" /> 24/7 Emergency
            </div>
            <div className="flex items-center gap-2">
              <Award className="size-4 text-gold" /> 10-Yr Warranty
            </div>
            <div className="flex items-center gap-2">
              <Star className="size-4 text-gold fill-gold" /> 4.9 · 2,847 reviews
            </div>
          </div>
        </div>
          ...
          <div className="relative">
            ...
            <div className="relative bg-card/90 backdrop-blur rounded-3xl border border-border p-7 shadow-luxe animate-float">
              ...
              <div className="text-sm text-muted-foreground">
                average arrival across Dallas County
              </div>
              <div className="mt-5 space-y-3">
                {[
                  ...
                  <div key={n} className="flex items-center justify-between text-sm">
                    <div className="flex items-center gap-2">
                      <MapPin className="size-4 text-gold" /> {n}
                    </div>
...
export function ZipChecker() {
  ...
  return (
    <section className="py-24 md:py-40 -mt-12 relative z-10">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto rounded-2xl gradient-navy p-10 md:p-14 shadow-luxe text-white relative overflow-hidden">
          ...
          <div className="relative grid md:grid-cols-[1fr_auto] gap-10 md:gap-14 items-end">
            <div>
              <div className="text-[10px] uppercase tracking-[0.28em] text-gold mb-4">
                Service Area Check
              </div>
              <h3 className="font-sans text-3xl md:text-4xl font-bold leading-tight tracking-tight no-ligatures">
                Are we in your neighborhood?
              </h3>
              <p className="text-white/65 mt-3 text-sm md:text-base max-w-md">
                Enter your Dallas zip — get instant availability.
              </p>
            </div>
            <div className="flex gap-3 items-center">
              ...
              />
              <button onClick={check} className="btn-elite is-primary h-12 px-7">
                Check
              </button>
            </div>
          </div>
          {result && (
            <div
              className={`mt-8 rounded-md p-4 border ${result === "yes" ? "bg-emerald-500/10 border-emerald-400/25" : "bg-amber-500/10 border-amber-400/25"} animate-fade-up`}
            >
              {result === "yes" ? (
                <div className="flex items-center gap-2 text-emerald-200">
                  <CheckCircle2 className="size-5" /> You're in our priority zone — same-day service
                  available.
                </div>
              ) : (
                <div className="text-amber-100">
                  We may still serve {zip}. Call {PHONE} to confirm coverage.
                </div>
              )}
            </div>
          )}
...
const SERVICES = [
  {
    ...
    img: acImg,
    copy: "Premium cooling systems engineered for Texas summers. SEER 16–22 installs with lifetime labor on select brands.",
    price: "From $89",
  },
  {
    icon: Flame,
    ...
    img: furnaceImg,
    copy: "Gas and electric furnace tune-ups, repairs and full replacements. Same-day ignitor & blower service.",
    price: "From $79",
  },
  {
    icon: Sparkles,
    title: "Smart Climate",
    img: smartImg,
    copy: "Nest, Ecobee and zoned smart-home integrations. App-controlled comfort, room-by-room.",
    price: "From $349",
  },
];
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-3xl mb-16 md:mb-20">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold leading-tight">
            Everything your home's air needs — done beautifully.
          </h2>
        </div>
            ...
            >
              <div className="relative">
                ...
                <img
                  ...
                  width={1024}
                  height={768}
                  className="relative rounded-3xl shadow-luxe w-full h-[420px] object-cover"
                />
              </div>
              <div>
                ...
                <div className="flex items-center gap-6">
                  ...
                  <a
                    href="#booking"
                    className="inline-flex items-center gap-1.5 font-semibold border-b border-gold/40 hover:border-gold pb-1"
                  >
                    Book this service
                  </a>
                </div>
...
export function Calculator() {
  ...
  const exportPdf = () => {
    ...
    if (!w) return;
    w.document
      .write(`<html><head><title>Elite Air Estimate</title><style>body{font-family:Georgia,serif;padding:48px;color:#1a2238}h1{color:#c9a84c}hr{border:none;border-top:1px solid #ddd;margin:24px 0}</style></head><body>
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-3xl mb-16 md:mb-20">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold">
            Build your estimate in 30 seconds.
          </h2>
        </div>
          ...
          <div className="lg:col-span-3 bg-card rounded-3xl border border-border p-8 shadow-luxe">
            <div className="mb-8">
              <label className="text-sm font-semibold mb-3 block">
                System size: <span className="text-gold">{size} ton</span>
              </label>
              <input
                type="range"
                min={2}
              ...
              <div className="grid grid-cols-3 gap-2">
                {[
                  ...
                  <button
                    key={v}
                    onClick={() => setFreq(v)}
                    className={`btn-elite is-ghost h-12 text-sm ${freq === v ? "!bg-[color-mix(in_oklab,var(--color-gold)_10%,transparent)] !shadow-[inset_0_0_0_1px_color-mix(in_oklab,var(--color-gold)_45%,transparent)] text-foreground" : "text-muted-foreground"}`}
                  >
                    {l}
                  </button>
                ))}
            ...
            <div>
              ...
              <div className="grid sm:grid-cols-2 gap-2">
                {[
                  ["filter", "Premium filter +$180"],
                  ["uv", "UV purification +$420"],
                  ["duct", "Duct sealing +$650"],
                  ["smart", "Smart thermostat +$380"],
                ].map(([k, l]) => (
                  <button
                    key={k}
                    onClick={() => setAddons((a) => ({ ...a, [k]: !a[k] }))}
                    className={`btn-elite is-ghost h-12 text-sm justify-start px-4 ${addons[k] ? "!bg-[color-mix(in_oklab,var(--color-gold)_10%,transparent)] !shadow-[inset_0_0_0_1px_color-mix(in_oklab,var(--color-gold)_45%,transparent)]" : ""}`}
                  >
                    {addons[k] ? (
                      <CheckCircle2 className="size-4 text-gold" />
                    ) : (
                      <div className="size-4 rounded-sm border border-white/20" />
                    )}
                    {l}
                  </button>
                ))}
          ...
          <div className="lg:col-span-2 gradient-navy rounded-3xl p-8 text-white shadow-luxe relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="text-white/70 text-sm mb-8">
                All-in price · parts, labor, 10-yr warranty included
              </div>
              <div className="space-y-3">
                <button onClick={exportPdf} className="w-full btn-elite is-primary h-12">
                  <Download className="size-4" /> Export PDF
                </button>
                <button onClick={shareWa} className="w-full btn-elite is-ghost h-12 text-white">
                  <Share2 className="size-4" /> Share via WhatsApp
                </button>
                <a href="#booking" className="w-full btn-elite is-ghost h-12 text-white">
                  Lock this price
                </a>
              </div>
            </div>
...
export function Timeline() {
  const steps = [
    ...
    {
      t: "Tech dispatched",
      d: "Track your technician live. Average 38 min arrival.",
      icon: MapPin,
    },
    {
      t: "Diagnose & quote",
      d: "Flat-rate pricing. Zero surprises. Approve before any work.",
      icon: ShieldCheck,
    },
    {
      t: "Premium service",
      d: "White-glove install. Shoe covers. Spotless cleanup.",
      icon: Sparkles,
    },
    {
      t: "Lifetime support",
      d: "10-yr warranty, free annual checkup, priority hotline.",
      icon: BadgeCheck,
    },
  ];
  return (
        ...
        <div className="relative">
          ...
          <div className="space-y-12">
            {steps.map((s, i) => (
              <div
                key={i}
                className={`relative grid md:grid-cols-2 gap-8 items-center ${i % 2 ? "md:[&>*:first-child]:order-2 md:[&>*:first-child]:text-left md:text-right" : ""}`}
              >
...
const TESTIMONIALS = [
  {
    ...
    area: "Highland Park",
    quote:
      "Replaced our entire system in one day. The crew was immaculate — booties, blankets, the works. Worth every penny.",
    rating: 5,
  },
  {
    name: "David & Linh K.",
    area: "Plano",
    quote:
      "Called at 11pm. Tech was here by midnight. Cool air by 1am. Unreal service at any price point.",
    rating: 5,
  },
  {
    name: "James Whitfield",
    area: "Preston Hollow",
    quote: "Third HVAC company we tried. Should have been the first. Honest, fast, premium work.",
    rating: 5,
  },
];
    ...
    <section id="reviews" className="py-32 md:py-40 bg-muted/30">
      <div className="container mx-auto px-6">
        <div className="max-w-3xl mb-16 md:mb-20">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold">
            Dallas families, in their own words.
          </h2>
        </div>
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          <div
            className="relative aspect-video rounded-3xl overflow-hidden shadow-luxe group cursor-pointer"
            role="button"
            tabIndex={0}
            ...
            aria-label="Play featured customer story"
          >
            <img
              src={acImg}
          ...
          {videoOpen && (
            ...
            >
              <div
                className="relative w-full max-w-2xl rounded-3xl bg-card p-8 shadow-luxe"
                onClick={(e) => e.stopPropagation()}
              >
                <button
                  type="button"
                  className="absolute top-4 right-4 btn-elite is-ghost is-icon"
                ...
                <h3 id="video-story-title" className="font-display text-2xl font-bold mb-3">
                  The Hendersons · Highland Park
                </h3>
                <p className="text-muted-foreground leading-relaxed mb-6">
                  Full-length video testimonials are coming soon. Meanwhile, read how Dallas
                  families describe their Elite Air experience — or book a visit to see our
                  white-glove process firsthand.
                </p>
                <div className="flex flex-wrap gap-3">
                  <a
                    href="#booking"
                    className="btn-elite is-primary h-11 px-6 text-sm"
                    onClick={() => setVideoOpen(false)}
                  >
                    Book a visit
                  </a>
                  <button
                    type="button"
                    className="btn-elite is-ghost h-11 px-6 text-sm"
                    onClick={() => setVideoOpen(false)}
                  >
                    Close
                  </button>
          ...
          <div>
            <div className="bg-card rounded-3xl p-8 border border-border shadow-luxe">
              ...
              <p className="font-display text-2xl leading-snug italic mb-6">
            ...
            <div className="flex gap-2 mt-5">
              {TESTIMONIALS.map((_, k) => (
                <button
                  key={k}
                  onClick={() => setI(k)}
                  className={`h-1.5 rounded-full transition-all ${k === i ? "w-10 bg-gold" : "w-5 bg-border"}`}
      ...
      <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold mb-5">
            Your home's HVAC, on a single dashboard.
          </h2>
          <p className="text-muted-foreground text-lg mb-8">
            Track service history, warranty status, smart thermostat data, and your next maintenance
            visit. White-glove transparency.
          </p>
          <ul className="space-y-3 mb-8">
            {[
              "Live system health scores",
              "One-tap reschedule",
              "Maintenance records & PDFs",
            ...
            {!demo ? (
              <div className="p-8">
                ...
                <input
                  ...
                  className="w-full h-12 rounded-xl bg-muted px-4 mb-4 outline-none focus:ring-2 focus:ring-gold"
                />
                <button onClick={() => setDemo(true)} className="w-full btn-elite is-primary h-12">
                  Enter live demo
                </button>
                <div className="text-xs text-muted-foreground mt-3 text-center">
                  Demo pre-filled · click to enter
                </div>
              </div>
            ) : (
              <div className="p-8 animate-fade-up">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="size-10 rounded-full gradient-gold flex items-center justify-center text-navy font-bold">
                    H
                  </div>
                </div>
                ...
                <div className="rounded-2xl bg-muted p-4 text-sm">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-gold font-semibold">Active · 7y left</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-muted-foreground">Last service</span>
                    <span>Feb 2 · Tune-up</span>
                  </div>
                </div>
              </div>
            )}
...
export function Booking() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError("We couldn't submit your request. Please call us directly or try again.");
    } finally {
      setSubmitting(false);
    }
  };
  return (
    <section
      id="booking"
      className="py-32 md:py-40 gradient-navy text-white relative overflow-hidden"
    >
      ...
      <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center relative">
        <div>
          ...
          <p className="text-white/75 text-lg mb-8">
            Submit below and we'll text you a confirmation in under 60 seconds, plus a live tech ETA
        ...
        <div className="bg-white/[0.04] backdrop-blur border border-white/15 rounded-3xl p-8 shadow-luxe">
          {sent ? (
            <div className="text-center py-12 animate-fade-up">
              <div className="size-16 rounded-full gradient-gold mx-auto flex items-center justify-center mb-5">
                <CheckCircle2 className="size-8 text-navy" />
              </div>
              <h3 className="font-display text-3xl font-bold mb-2">Booking received.</h3>
              <p className="text-white/70">
                Confirmation texted to {form.phone}. Reference {confirmationId}. Our concierge will
                reach out shortly.
              </p>
            </div>
          ) : (
            <form onSubmit={submit} className="space-y-4">
              <div className="grid sm:grid-cols-2 gap-4">
                <input
                  ...
                  className="h-12 rounded-xl bg-white/10 border border-white/15 px-4 placeholder:text-white/40 outline-none focus:border-gold"
                />
                <input
                  required
                  value={form.phone}
              ...
              <input
                ...
                className="w-full h-12 rounded-xl bg-white/10 border border-white/15 px-4 placeholder:text-white/40 outline-none focus:border-gold"
              />
              <div className="grid sm:grid-cols-2 gap-4">
                <select
                  value={form.service}
                  onChange={(e) => setForm({ ...form, service: e.target.value })}
                  className="h-12 rounded-xl bg-white/10 border border-white/15 px-4 outline-none focus:border-gold"
                >
                  {[
                    "AC Repair",
                    "AC Install",
                ...
                <select
                  ...
                  className="h-12 rounded-xl bg-white/10 border border-white/15 px-4 outline-none focus:border-gold"
                >
                  {["ASAP", "Today", "Tomorrow", "This week", "Schedule later"].map((o) => (
                    <option key={o} className="bg-navy">
                      {o}
                    </option>
                  ))}
              ...
              <textarea
                ...
                rows={4}
                className="w-full rounded-xl bg-white/10 border border-white/15 p-4 placeholder:text-white/40 outline-none focus:border-gold"
              />
              {error && <div className="text-sm text-amber-200">{error}</div>}
              <button
                type="submit"
                disabled={submitting}
                className="w-full btn-elite is-primary h-14 text-base disabled:opacity-60"
              >
                {submitting ? "Submitting…" : "Confirm booking"}
              </button>
              <div className="text-xs text-white/50 text-center">
                By submitting, you agree to text/email follow-ups. Unsubscribe anytime.
              </div>
            </form>
          )}
        </div>
...
const ARTICLES = [
  {
    t: "How often should you replace your air filter?",
    c: "The 30-day rule is outdated. Here's a smarter schedule based on home size, pets, and allergies.",
    read: "4 min",
  },
  {
    t: "SEER 14 vs SEER 22 — what's actually worth it?",
    c: "We modeled 8 Dallas homes. The break-even might surprise you.",
    read: "6 min",
  },
  {
    t: "Why your AC freezes (and how to fix it tonight)",
    c: "Three causes, three fixes — and when to stop DIYing.",
    read: "5 min",
  },
];
      ...
      <div className="container mx-auto px-6">
        <div className="flex items-end justify-between gap-6 mb-12 flex-wrap">
          <div>
            <div className="text-xs uppercase tracking-[0.2em] text-gold mb-3 flex items-center gap-2">
              <GraduationCap className="size-4" /> Maintenance Academy
            </div>
            <h2 className="font-display text-4xl md:text-5xl font-bold">
          ...
          <a
            href="#academy"
            className="text-gold font-semibold inline-flex items-center gap-1.5 hover:gap-2.5 transition-all"
          >
            All articles
          </a>
        </div>
        <div className="grid md:grid-cols-3 gap-6">
          {ARTICLES.map((a, i) => (
            <article
              key={i}
              className="group rounded-3xl border border-border bg-card p-7 hover:shadow-luxe hover:border-gold/40 transition-all"
            >
              ...
              <a
                href="#booking"
                className="inline-flex items-center gap-1.5 text-sm font-semibold hover:text-gold transition-colors"
              >
                Read more
              </a>
            </article>
      ...
      <div className="container mx-auto px-6">
        <div className="rounded-3xl gradient-navy p-10 md:p-14 text-white relative overflow-hidden shadow-luxe">
          ...
          <div className="relative grid md:grid-cols-[1fr_auto] gap-8 items-center">
            <div>
              <div className="text-xs uppercase tracking-[0.2em] text-gold mb-3 flex items-center gap-2">
                <Gift className="size-4" /> Refer a neighbor
              </div>
              <h2 className="font-display text-3xl md:text-4xl font-bold mb-3">
                Give $100. Get $100.
              </h2>
              <p className="text-white/75 max-w-xl">
                Send a friend your referral link. When they book their first service, you both get a
                credit toward your next visit or maintenance plan.
              </p>
            </div>
            <a
              href="#booking"
              className="btn-elite is-primary h-14 px-8 self-start whitespace-nowrap"
            >
              <Users className="size-5" /> Get my link
            </a>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-4 gap-12 mb-14">
          <div>
            <div className="flex items-center gap-2.5 mb-5">
              ...
              <div>
                <div className="font-display font-bold text-lg">Elite Air</div>
                <div className="text-[10px] uppercase tracking-[0.2em] text-gold -mt-0.5">
                  Dallas
                </div>
              </div>
            </div>
            <p className="text-white/65 text-sm leading-relaxed">
              Luxury HVAC, AC repair, and furnace service for Dallas' finest homes. Licensed ·
              Insured · TACL #B12847
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/75">
              <li className="flex gap-2">
                <Phone className="size-4 text-gold shrink-0 mt-0.5" /> {PHONE}
              </li>
              <li className="flex gap-2">
                <MapPin className="size-4 text-gold shrink-0 mt-0.5" /> 2424 N Pearl St, Dallas, TX
                75201
              </li>
              <li className="flex gap-2">
                <Clock className="size-4 text-gold shrink-0 mt-0.5" /> 24/7 emergency · M–F 7am–7pm
                office
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-wrap items-center justify-between gap-4 text-xs text-white/50">
          ...
          <div className="flex gap-5">
            ...
            <a href="/owner" className="hover:text-gold">
              Owner
            </a>
          </div>
        </div>
